...
def test_split_host_port_tcp4() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_tcp4_localhost() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_tcp6() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_tcp6_localhost() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_udp4() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_udp4_localhost() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_udp6() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_udp6_localhost() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_ip4() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_ip4_localhost() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_ip6() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_ip6_localhost() raises:
    var hp: HostPort
    try:
...
def test_split_host_port_error_ip_with_port() raises:
    with assert_raises(
...
def test_split_host_port_error_missing_port_ipv4() raises:
    with assert_raises(
        contains=(
...
def test_split_host_port_error_missing_port_ipv6() raises:
    with assert_raises(
